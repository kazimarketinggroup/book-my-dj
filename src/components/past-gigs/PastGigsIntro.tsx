    ...
    <section className="scroll-mt-20 bg-background py-10 sm:py-14 lg:pt-16 lg:pb-12 text-foreground">
      <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <Link
            href="/contact"
            className="inline-flex h-[40px] w-[171px] items-center justify-center rounded-[5px] bg-gradient-to-r from-[#910870] via-[#520577] to-[#24081E] font-display text-[16px] font-medium text-white shadow-md transition-opacity hover:opacity-90"
          >
            Book My DJ
          </Link>
          <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-[419px]">
            ...
            <div className="relative h-[280px] sm:h-[350px] lg:h-full w-full overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-black/40 backdrop-blur-xs border border-white/20 transition-transform hover:scale-110 cursor-pointer">
                  <svg
                    viewBox="0 0 24 24"
                    fill="white"
