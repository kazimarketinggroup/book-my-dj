...
const field =
  "field-motion h-10 w-full rounded-lg border border-hairline bg-surface-3 px-3 text-sm text-foreground placeholder:text-muted outline-none focus:border-brand-light focus:ring-1 focus:ring-brand-light";
              ...
              return (
                <label
                  ...
                  className={`flex cursor-pointer items-center gap-3 rounded-lg border px-3 py-2 text-sm transition-colors ${
                    selected
                      ? "border-brand-light bg-brand/10 text-foreground"
                      : "border-hairline bg-surface-3 text-muted hover:border-brand-light/50"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className={`${field} mt-1.5 scheme-dark`}
              />
            </div>
