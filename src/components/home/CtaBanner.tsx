  ...
  return (
    <section id="contact" className="scroll-mt-20 py-12 lg:py-16 bg-background transition-colors duration-200">
      <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        <div className="relative overflow-hidden rounded-[20px] border border-hairline bg-surface/90 px-6 py-12 text-center shadow-xl backdrop-blur-md sm:px-12 lg:py-16">
