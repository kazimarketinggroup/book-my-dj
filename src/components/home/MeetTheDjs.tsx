...
export default function MeetTheDjs() {
  return (
    <section id="djs" className="scroll-mt-20 py-12 lg:py-16 bg-background transition-colors duration-200">
      <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,2fr)] lg:gap-12">
          <div>
            ...
            <p className="mt-3 max-w-xs font-sans text-[16px] sm:text-[18px] leading-[25px] text-muted">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {djs.map((dj) => (
              <Link key={dj.name} href={dj.href} className="block group">
                <figure
                  className="relative aspect-[456/331] w-full overflow-hidden rounded-[15px] border border-hairline bg-card shadow-2xl"
                >
                  <Image
                    src={dj.image}
                    alt={dj.alt}
                  ...
                  <figcaption className="absolute inset-x-0 bottom-0 p-6">
                    ...
                    <p className="mt-1 font-sans text-[16px] sm:text-[18px] font-normal text-zinc-300">
                      {dj.role}
                    </p>
                  </figcaption>
                </figure>
