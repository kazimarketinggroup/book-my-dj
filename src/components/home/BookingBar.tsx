const inputBase =
  "h-[62.44px] w-full rounded-[10px] border border-slate-200 bg-slate-50 px-4 font-sans text-[16.6px] text-foreground placeholder:text-muted outline-none transition-colors focus:border-brand-light focus:bg-white focus:ring-1 focus:ring-brand-light";
  ...
  return (
    <section id="book" className="scroll-mt-20 py-8 lg:py-12 bg-background transition-colors duration-200">
      <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        <div className="rounded-[20px] border border-slate-200/90 bg-white p-6 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.08)] backdrop-blur-md lg:p-8">
